function tumor_encapsulation_driver_v3
%v2 calculates the difference between the tumor and boundary brightness
%differently, on a vector-by-vector basis instead of using medians
